# Install script for directory: /home/zwt/lhy/MyProject/DepGraph/lonestar/analytics/distributed/triangle-counting
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xappsx")
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/bin" TYPE EXECUTABLE FILES "/home/zwt/lhy/MyProject/DepGraph/build/lonestar/analytics/distributed/triangle-counting/triangle-counting-dist")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/triangle-counting-dist" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/triangle-counting-dist")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/triangle-counting-dist"
